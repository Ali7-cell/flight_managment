...
def main():
    ...
    # Domain scheduled automated jobs
    ...
    scheduler.add_job(lambda: call_trigger("/trigger/price-drop-alerts"), "cron", hour="*/6", id="price_drop_alerts")
    scheduler.add_job(lambda: call_trigger("/trigger/fraud-scan"), "cron", hour="*/4", id="fraud_scan")
    scheduler.add_job(lambda: call_trigger("/trigger/fraud-batch-review"), "cron", hour=2, id="fraud_batch_review")
    ...
    scheduler.add_job(lambda: call_trigger("/trigger/reconciliation"), "interval", hours=1, id="reconciliation")
