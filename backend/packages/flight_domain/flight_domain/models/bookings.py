...
class Booking(Base):
    ...
    quantity = Column(Integer, nullable=False)
    seat_number = Column(String, nullable=True)
    fare_type = Column(String, nullable=False, default="flex")
    ...
    __table_args__ = (
        ...
        CheckConstraint("fare_type in ('basic_economy', 'flex')", name="chk_booking_fare_type"),
...
class WaitlistEntry(Base):
    ...
    quantity = Column(Integer, nullable=False)
    priority_score = Column(Numeric, nullable=False, default=0.0)
    fare_type = Column(String, nullable=False, default="flex")
    ...
    __table_args__ = (
        ...
        CheckConstraint("fare_type in ('basic_economy', 'flex')", name="chk_waitlist_fare_type"),
...
class Refund(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("status in ('pending','approved','rejected','escalated','completed')", name="chk_refund_status"),
    )
